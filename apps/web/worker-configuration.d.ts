/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker-configuration.d.ts` (hash: 813683b8619f45c8a838626c15695f02)
...
interface __BaseEnv_Env {
	...
	MATTER_ORCHESTRATION: Workflow<Parameters<import("./src/worker/index").MatterOrchestrationWorkflow['run']>[0]['payload']>;
	USAGE_ANALYTICS?: AnalyticsEngineDataset;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "LegalWorker";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_NAME" | "IUSIA_ENV" | "ORCHESTRATION_MODE" | "BETTER_AUTH_SECRET" | "CLOUDFLARE_ACCOUNT_ID" | "AI_GATEWAY_TOKEN" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "APP_URL">> {}
}
